...
if (isIOSChrome) {
   ...
   $(".container").html("<h1>PLEASE USE CHROME</h1>");
}

if (window.location.protocol === 'https:') {
    $(".container").html("<h1>PLEASE GO TO OUR NEW RELEASE PAGE: <p></p> <a href='http://release.kaiworship.xyz'>Eleven 51 API release</a></h1>");
}
